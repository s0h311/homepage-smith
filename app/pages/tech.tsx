        ...
        <main className='max-w-5xl mx-auto w-full grid md:grid-cols-[1fr_2fr] gap-12'>
          <section>
            ...
            <p className='text-slate-400 mb-8 text-lg leading-relaxed'>
              I specialize in <strong>robust software development</strong> and building scalable systems. Proud
              organizer of <strong>DevFest Hamburg</strong> (2024 & 2025).
            </p>
            ...
            <div className='flex flex-col gap-4'>
              <div className='flex gap-4'>
                <Button
                  variant='outline'
                  className='gap-2 bg-transparent text-slate-50 border-slate-700 hover:bg-slate-800 hover:text-white'
                  asChild
                >
                  <a
                ...
                >
                  <a
                    href='https://linkedin.com/in/soheiln'
                    target='_blank'
                    rel='noreferrer'
                  >
          ...
          <section className='space-y-8'>
            ...
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className='border border-slate-800 bg-slate-900/50 p-6 rounded-lg hover:border-cyan-500/50 transition-colors group'
              >
                ...
                <p className='text-slate-400 text-sm mb-4'>
                  A brief description of what this project does and the problems it solves. Focused on performance and
                  user experience.
                </p>
                <a
                  href='#'

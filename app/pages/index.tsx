        ...
        <div className='h-full w-full overflow-y-auto snap-y snap-mandatory scroll-smooth md:overflow-hidden md:snap-none'>
            ...
            return (
                ...
                >
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 transition-opacity duration-1000 ${isActive ? 'opacity-100' : ''} md:hidden`} />
                    ...
                    <div className={`absolute -right-24 -bottom-24 md:hidden pointer-events-none transition-all duration-[1.5s] ease-out will-change-transform
                    ...
                    <div className='relative z-10 flex flex-col items-center gap-4 p-8 pt-24 pb-12 text-center w-full max-w-md h-full justify-center md:justify-center md:p-8'>
                        ...
                        <div className={`relative mb-2 transition-all duration-1000 delay-100 will-change-transform
                        ...
                        `}>
                            <div className={`absolute inset-0 bg-white/20 blur-3xl rounded-full scale-150 animate-pulse md:hidden`} />
                            <section.icon className={`w-16 h-16 md:w-20 md:h-20 stroke-[1.5px] relative z-10 ${section.accentColor} md:text-inherit drop-shadow-lg`} />
                        </div>
                        ...
                        <div className={`absolute bottom-8 left-0 right-0 flex justify-center md:hidden transition-all duration-1000 delay-500 ${isActive ? 'opacity-70 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                            {index < sections.length - 1 ? (
                                ...
                                <span className="text-xs uppercase tracking-[0.3em] opacity-50 font-medium py-2 border-b border-transparent hover:border-white/50 transition-colors">Start Exploring</span>
                            )}
                        </div>
                    </div>
                </Link>

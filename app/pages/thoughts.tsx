  ...
  const posts = [
    {
      ...
      excerpt:
        'Reading Hawking reminds me of how small we are, yet how significant our curiosity is. A reflection on the future of humanity and AI.',
    },
    {
      id: 2,
      ...
      excerpt:
        'Harari paints a provocative picture of what comes next. Are we really upgrading ourselves into gods, or just better data processors?',
    },
    {
      id: 3,
      ...
      excerpt:
        'Looking back at how shared myths enabled human cooperation on a global scale. It changes how I view modern software communities.',
    },
  ]
      ...
      <main className='max-w-2xl mx-auto space-y-16'>
        {posts.map((post) => (
          ...
          >
            ...
            <p className='text-stone-600 leading-relaxed font-sans'>{post.excerpt}</p>
